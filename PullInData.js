    ...
    function myFunction() {
		...
		var url = new URL("https://localhost:55530/api/mlisa/pf_FixturesFrontApp?VesselName=" + encodeURIComponent(fixtureName) + "&FixtureNumber=" + encodeURIComponent(fixtureNumber));
